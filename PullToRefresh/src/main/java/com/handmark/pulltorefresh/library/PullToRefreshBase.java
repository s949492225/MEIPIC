...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected final LoadingLayout getHeaderLayout() {
		((TextView)mHeaderLayout.findViewById(R.id.pull_to_refresh_text)).setTextColor(getResources().getColor(R.color.textColor));
		((TextView)mHeaderLayout.findViewById(R.id.pull_to_refresh_sub_text)).setTextColor(getResources().getColor(R.color.textColor));
